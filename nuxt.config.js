export default {
  ...
  publicRuntimeConfig: {
    ...
    strapiBaseUri: process.env.NODE_ENV === 'production' ? 'https://18.132.131.54' : 'http://localhost:1337',
    schemaPath: process.env.NODE_ENV === 'production' ? 'https://18.132.131.54/graphql' : 'http://localhost:1337/graphql'
  },
  /*
  ** Headers of the page
  */
